...
class AllNearestNeighborExport implements FromView, ShouldAutoSize
{
    public function view(): View
    {
        ...
        foreach ($distributions as $distribusi) {
        ...
        return view('KepalaGudang.DataSet.export-Distribusi', [
